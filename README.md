...
This sample demonstrates how to run Video Editor SDK with [Flutter](https://flutter.dev/).
...
3. Set Banuba token in the sample app [VideoEditor initializer](https://github.com/Banuba/ve-sdk-flutter-integration-sample/blob/main/ios/Runner/VideoEditorModule.swift#L13) .
